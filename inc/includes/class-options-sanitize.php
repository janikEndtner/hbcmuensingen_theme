...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'milestonez-pro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'milestonez-pro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'milestonez-pro' ),
		'repeat'    => __( 'Repeat All', 'milestonez-pro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'milestonez-pro' ),
		'top center'    => __( 'Top Center', 'milestonez-pro' ),
		'top right'     => __( 'Top Right', 'milestonez-pro' ),
		'center left'   => __( 'Middle Left', 'milestonez-pro' ),
		'center center' => __( 'Middle Center', 'milestonez-pro' ),
		'center right'  => __( 'Middle Right', 'milestonez-pro' ),
		'bottom left'   => __( 'Bottom Left', 'milestonez-pro' ),
		'bottom center' => __( 'Bottom Center', 'milestonez-pro' ),
		'bottom right'  => __( 'Bottom Right', 'milestonez-pro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'milestonez-pro' ),
		'fixed'  => __( 'Fixed in Place', 'milestonez-pro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'milestonez-pro' ),
		'italic'      => __( 'Italic', 'milestonez-pro' ),
		'bold'        => __( 'Bold', 'milestonez-pro' ),
		'bold italic' => __( 'Bold Italic', 'milestonez-pro' )
		);
